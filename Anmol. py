...
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mbBillal dogar\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : Bilal dogar
...
def login(Bilal):
	...
	try:
		...
		print
		id=raw_input(S + '[☆] ' + S + 'Email: bilalking245' + G +'')
...
def menu():
	...
	print (S + '[☆] ' + G + 'User ID:https://www.facebook.com/profile.php?id=100064197562020 ' + R + a['id'])
	print(S+,[☆]+G+'No:03018959991
	print (S + 50*'-')
	print
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Bilal_Dogar')
	    ...
	    time.sleep(2)
	    os.system('cd $HOME/Bilal_Dogar && python2 .py')
	elif bm =='3':
...
def pb():
	...
	if bp =='':
		...
		try:
			...
			psb(S + '[☆]' + G + ' Account  Name: ' + W + op['Bilal'])
		except KeyError:
